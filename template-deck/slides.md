...
PRESENTER_NAME_PLACEHOLDER
<br>
<a href="REPO_URL_PLACEHOLDER" target="_blank" class="text-[#38bdf8] hover:text-white text-sm font-bold transition-colors">View on GitHub</a>
</div>
...
<div class="presenter-info">PRESENTER_NAME_PLACEHOLDER</div>
...
<!-- 
  Usage:
  layout: figure
  media: GOOGLE_DRIVE_FILE_ID or /local/path.png
...
Code blocks automatically use the **VS Code Dark Modern** theme for syntax highlighting.
